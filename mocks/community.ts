...
export const posts: Post[] = [
  ...
  },
  {
    ...
    content: 'Có ai biết địa chỉ phòng khám thú y uy tín ở quận Cầu Giấy không ạ? Mình cần đưa bé chó đi khám gấp.',
    likes: 5,
    comments: 12,
  ...
  },
  {
    ...
    content: 'Chia sẻ với mọi người một số loại thức ăn tốt cho chó con mà mình đã tìm hiểu:\n- Royal Canin\n- Hill\'s Science Diet\n- Purina Pro Plan\nMọi người có thêm gợi ý gì không?',
    likes: 42,
    comments: 18,
  ...
  },
  {
    ...
    content: 'Bé nhà mình mới 2 tháng tuổi. Đây là lần đầu mình nuôi mèo, mọi người có lời khuyên gì cho người mới không ạ?',
  ...
  },
  {
    ...
    content: 'Cuối tuần vừa rồi mình đã đưa bé cún đi dạo ở công viên Thủ Lệ. Bé rất thích và chạy nhảy không ngừng!',
  ...
  '2': [
    {
      ...
      userName: 'Lê Văn C',
      userAvatar: 'https://images.unsplash.com/photo-1599566150163-29194dcaad36',
      content: 'Bạn có thể thử phòng khám Pet Health ở ngõ 12 Trần Thái Tông. Mình hay đưa bé nhà mình đến đó, dịch vụ tốt lắm.',
    ...
    },
    {
      ...
      userName: 'Hoàng Văn E',
      userAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d',
      content: 'Mình gợi ý phòng khám Thú y Hà Nội ở Dịch Vọng. Đội ngũ bác sĩ chuyên môn cao và có nhiều thiết bị hiện đại.',
...
export const messages: Message[] = [
  {
    ...
    senderId: 'user1',
    receiverId: 'vet1',
    content: 'Chào bác sĩ, bé mèo nhà tôi dạo này biếng ăn và hay nằm một chỗ. Tôi nên làm gì ạ?',
  ...
  },
  {
    ...
    senderId: 'vet1',
    receiverId: 'user1',
    content: 'Chào bạn, bạn có thể cho tôi biết bé mèo bao nhiêu tuổi và tình trạng này kéo dài bao lâu rồi?',
  ...
  },
  {
    ...
    senderId: 'vet1',
    receiverId: 'user1',
    content: 'Bạn có thể kiểm tra nhiệt độ của bé không? Và bé có biểu hiện nôn mửa hoặc tiêu chảy không?',
  ...
  },
  {
    ...
    senderId: 'user1',
    receiverId: 'vet1',
    content: 'Tôi không có nhiệt kế để đo, nhưng bé không có biểu hiện nôn mửa hay tiêu chảy ạ.',
  ...
  },
  {
    ...
    senderId: 'vet1',
    receiverId: 'user1',
    content: 'Trong trường hợp này, tôi khuyên bạn nên đưa bé đến phòng khám để kiểm tra trực tiếp. Có thể bé đang gặp vấn đề về tiêu hóa hoặc nhiễm trùng nhẹ. Bạn có thể đến phòng khám của chúng tôi vào lúc nào thuận tiện.',
