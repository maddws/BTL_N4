...
const diseases: Disease[] = [
    {
        ...
        description:
            'Bệnh Care (Parvovirus) là một bệnh truyền nhiễm nguy hiểm ở chó, đặc biệt là chó con. Virus tấn công vào đường tiêu hóa, gây ra các triệu chứng nghiêm trọng và có thể dẫn đến tử vong nếu không được điều trị kịp thời.',
        symptoms: [
        ...
        treatment:
            'Không có thuốc đặc trị cho bệnh Care, điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Chó bị bệnh cần được nhập viện để được truyền dịch, điều trị chống nôn, kháng sinh để ngăn ngừa nhiễm trùng thứ phát, và chăm sóc đặc biệt. Tỷ lệ sống sót cao nếu được điều trị sớm và đúng cách.',
        prevention:
            'Tiêm phòng là biện pháp phòng ngừa hiệu quả nhất. Chó con nên được tiêm phòng Care theo lịch từ 6-8 tuần tuổi và tiêm nhắc lại theo hướng dẫn của bác sĩ thú y. Hạn chế cho chó con tiếp xúc với môi trường bên ngoài và chó lạ cho đến khi hoàn thành đầy đủ các mũi tiêm phòng.',
        severity: 5,
        contagious: true,
    ...
    },
    {
        ...
        description:
            'Bệnh giun sán là tình trạng phổ biến ở chó mèo, do nhiễm các loại ký sinh trùng đường ruột. Có nhiều loại giun sán khác nhau có thể ảnh hưởng đến thú cưng, bao gồm giun tròn, giun móc, giun đũa, và sán dây.',
        symptoms: [
        ...
        treatment:
            'Điều trị bằng thuốc tẩy giun phù hợp với loại giun sán mà thú cưng nhiễm phải. Có nhiều loại thuốc tẩy giun khác nhau, bao gồm dạng viên, dạng nhỏ gáy, hoặc dạng tiêm. Cần tuân theo liều lượng và lịch tẩy giun do bác sĩ thú y hướng dẫn.',
        prevention:
            'Tẩy giun định kỳ theo lịch (thường là 3-4 tháng/lần đối với chó mèo trưởng thành, và thường xuyên hơn đối với chó mèo con). Giữ vệ sinh môi trường sống, thu gom phân thú cưng kịp thời. Kiểm soát bọ chét và các vật chủ trung gian khác.',
        severity: 3,
        contagious: true,
    ...
    },
    {
        ...
        description:
            'Viêm da là tình trạng viêm nhiễm ở da, gây ngứa ngáy, khó chịu cho thú cưng. Có nhiều loại viêm da khác nhau, bao gồm viêm da dị ứng, viêm da do nấm, viêm da do ký sinh trùng, và viêm da do vi khuẩn.',
        symptoms: [
        ...
        treatment:
            'Điều trị phụ thuộc vào nguyên nhân gây bệnh. Có thể bao gồm thuốc kháng sinh (nếu do vi khuẩn), thuốc kháng nấm (nếu do nấm), thuốc diệt ký sinh trùng (nếu do ghẻ, ve), thuốc kháng histamine hoặc steroid (nếu do dị ứng). Ngoài ra, có thể cần tắm với dầu gội đặc trị và thay đổi chế độ ăn.',
        prevention:
            'Kiểm soát ký sinh trùng (bọ chét, ve) bằng các sản phẩm phòng ngừa. Tắm rửa thường xuyên với dầu gội phù hợp. Chế độ ăn cân bằng, bổ sung omega-3 và omega-6 để duy trì da khỏe mạnh. Tránh các chất gây dị ứng đã biết.',
        severity: 3,
        contagious: false,
        commonIn: ['Chó', 'Mèo'],
        petType: ['dog', 'cat'],
    ...
    },
    {
        ...
        description:
            'Viêm tai là tình trạng viêm nhiễm ở ống tai ngoài, rất phổ biến ở chó và mèo. Bệnh gây khó chịu và đau đớn cho thú cưng, nếu không được điều trị kịp thời có thể dẫn đến các biến chứng nghiêm trọng.',
        symptoms: [
        ...
        treatment:
            'Làm sạch tai cẩn thận để loại bỏ dịch tiết và mảnh vụn. Sử dụng thuốc nhỏ tai theo chỉ định của bác sĩ thú y, có thể bao gồm kháng sinh, kháng nấm, thuốc kháng viêm, hoặc thuốc diệt ký sinh trùng tùy thuộc vào nguyên nhân. Trong trường hợp nặng, có thể cần điều trị toàn thân hoặc phẫu thuật.',
        prevention:
            'Vệ sinh tai thường xuyên với dung dịch làm sạch tai phù hợp. Giữ tai khô ráo, đặc biệt sau khi tắm hoặc bơi. Điều trị dị ứng nếu có. Kiểm tra tai thường xuyên để phát hiện sớm các dấu hiệu bất thường.',
        severity: 3,
        contagious: false,
    ...
    },
    {
        ...
        description:
            'Calicivirus là một bệnh virus phổ biến ở mèo, gây ra các triệu chứng hô hấp và loét miệng. Đây là một trong những nguyên nhân chính gây bệnh đường hô hấp trên ở mèo.',
        symptoms: [
            'Sốt',
        ...
        treatment:
            'Không có thuốc đặc trị cho virus, điều trị chủ yếu là hỗ trợ và điều trị triệu chứng. Bao gồm giữ ấm, đảm bảo dinh dưỡng và nước uống, kháng sinh để ngăn ngừa nhiễm trùng thứ phát, và thuốc giảm đau nếu cần. Trong trường hợp nặng, có thể cần nhập viện và truyền dịch.',
        prevention:
            'Tiêm phòng là biện pháp phòng ngừa hiệu quả nhất. Mèo nên được tiêm phòng Calicivirus theo lịch từ 6-8 tuần tuổi và tiêm nhắc lại theo hướng dẫn của bác sĩ thú y. Hạn chế tiếp xúc với mèo lạ, đặc biệt là mèo có dấu hiệu bệnh.',
        severity: 4,
        contagious: true,
    ...
    },
    {
        ...
        description:
            'Là tình trạng viêm nhiễm niêm mạc dạ dày và ruột, thường gặp ở chó mèo do ăn phải thức ăn bẩn, độc hoặc thay đổi khẩu phần đột ngột.',
        symptoms: ['Nôn mửa', 'Tiêu chảy', 'Chán ăn', 'Sốt nhẹ', 'Mệt mỏi'],
        causes: 'Do virus, vi khuẩn, ký sinh trùng hoặc thay đổi thức ăn đột ngột. Cũng có thể do ăn phải vật thể lạ, chất hóa học.',
        treatment:
            'Nhịn ăn 12–24 giờ để dạ dày nghỉ ngơi, sau đó cho ăn thức ăn dễ tiêu. Có thể cần thuốc chống nôn, kháng sinh, và truyền dịch nếu mất nước.',
        prevention:
            'Không cho thú cưng ăn đồ ăn thừa, ôi thiu. Chuyển đổi khẩu phần từ từ. Giữ vệ sinh bát ăn và môi trường sống.',
        severity: 2,
        contagious: false,
        commonIn: ['Chó', 'Mèo', 'Đặc biệt là thú cưng con'],
        petType: ['dog', 'cat'],
        ...
        medications: [
            {
                name: 'Metronidazole',
                description: 'Kháng sinh, chống tiêu chảy do vi khuẩn',
            },
    ...
    },
    {
        ...
        description:
            'Viêm tụy cấp là tình trạng tuyến tụy bị viêm do ăn thức ăn nhiều dầu mỡ hoặc do rối loạn chuyển hóa, gây đau đớn nghiêm trọng.',
        symptoms: ['Nôn mửa liên tục', 'Đau bụng dữ dội', 'Sốt', 'Mệt mỏi', 'Chán ăn', 'Tiêu chảy'],
        causes: 'Chủ yếu do ăn thức ăn nhiều chất béo, rối loạn lipid máu, hoặc do bệnh nội tiết như Cushing.',
        treatment:
            'Cần điều trị nội trú với truyền dịch, thuốc giảm đau, chống nôn và thay đổi khẩu phần ăn ít béo. Có thể cần xét nghiệm máu và siêu âm.',
        prevention:
            'Tránh cho ăn thức ăn dầu mỡ, duy trì cân nặng hợp lý và kiểm tra sức khỏe định kỳ.',
        severity: 4,
        contagious: false,
    ...
    // Bệnh 3: Tiêu chảy do thay đổi thức ăn
    {
        ...
        description:
            'Tiêu chảy do thay đổi khẩu phần xảy ra khi thức ăn mới được giới thiệu quá đột ngột khiến hệ tiêu hóa không thích nghi kịp.',
        symptoms: [
            'Phân lỏng hoặc nhầy',
            'Đi ngoài nhiều lần',
        ...
        treatment:
            'Chuyển đổi thức ăn dần dần trong 7–10 ngày. Có thể dùng men tiêu hóa hoặc thuốc cầm tiêu chảy nhẹ nếu cần.',
    ...
    // Bệnh 4: Táo bón mãn tính
    {
        ...
        description:
            'Táo bón mãn tính là tình trạng phân khô và tích tụ lâu ngày trong ruột, gây khó khăn hoặc đau đớn khi đi vệ sinh.',
        symptoms: [
        ...
        treatment:
            'Tăng cường chất xơ, bổ sung nước, có thể dùng thuốc làm mềm phân hoặc thuốc nhuận tràng. Trường hợp nặng có thể cần can thiệp y tế.',
    ...
    },
    {
        ...
        description:
            'Viêm da dị ứng là tình trạng da bị viêm do phản ứng quá mẫn với các yếu tố như phấn hoa, thức ăn, hoặc môi trường.',
        symptoms: [
            'Ngứa ngáy dữ dội',
        ...
        treatment:
            'Điều trị bằng thuốc kháng histamine, steroid, và tránh tiếp xúc với tác nhân dị ứng. Có thể cần thay đổi chế độ ăn.',
        prevention:
            'Giữ nhà cửa sạch sẽ, hạn chế các tác nhân dị ứng, tắm rửa định kỳ bằng dầu gội chuyên biệt.',
        severity: 3,
        contagious: false,
...

    {
        ...
        description:
            'Nấm da là bệnh truyền nhiễm do nấm gây ra, làm xuất hiện những mảng da tròn, không lông, bong tróc.',
        symptoms: [
        ...
        treatment:
            'Tắm thuốc kháng nấm, bôi thuốc đặc trị và trong trường hợp nặng có thể dùng thuốc uống.',
...

    {
        ...
        description:
            'Ghẻ sarcoptes là bệnh da do ký sinh trùng Sarcoptes scabiei gây ra, cực kỳ ngứa và dễ lây.',
        symptoms: [
            'Ngứa dữ dội',
        ...
        treatment:
            'Tắm thuốc diệt ký sinh trùng, sử dụng thuốc bôi hoặc tiêm theo phác đồ. Khử trùng nơi ở.',
    ...
    },
    {
        ...
        description:
            'Viêm phế quản là tình trạng viêm đường hô hấp dưới gây ho mãn tính, thường gặp ở chó lớn tuổi hoặc sống trong môi trường ô nhiễm.',
        symptoms: [
            'Ho khan kéo dài',
            'Thở khò khè',
...

    {
        ...
        description:
            'Là bệnh hô hấp cấp tính ở mèo do virus herpes gây ra, đặc biệt nguy hiểm với mèo con.',
        symptoms: [
            'Hắt hơi liên tục',
        ...
        treatment:
            'Chăm sóc hỗ trợ, giữ ấm, bổ sung nước, có thể dùng kháng sinh chống nhiễm trùng thứ phát.',
    ...
    // === CÁC BỆNH KÝ SINH TRÙNG ===
    {
        ...
        description:
            'Là tình trạng nhiễm ký sinh trùng Otodectes cynotis trong tai, gây ngứa ngáy và viêm tai.',
        symptoms: [
            'Gãi tai liên tục',
            'Lắc đầu',
...

    {
        ...
        description:
            'Bọ chét ký sinh ngoài da, hút máu gây ngứa, dị ứng, thậm chí thiếu máu nếu nhiễm nặng.',
        symptoms: [
            'Ngứa ngáy dữ dội',
            'Rụng lông theo mảng',
        ...
        treatment:
            'Sử dụng thuốc nhỏ gáy, xịt hoặc tắm thuốc diệt bọ chét. Cần xử lý cả môi trường.',
        ...
        medications: [
            ...
            {
                name: 'Imidacloprid',
                description: 'Hoạt chất phổ biến trong thuốc nhỏ gáy',
            },
        ],
        images: [
