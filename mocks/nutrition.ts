...
export const nutritionInfo: NutritionInfo[] = [
  {
    ...
    description: 'Chó cần một chế độ ăn cân bằng với protein, chất béo, carbohydrate, vitamin và khoáng chất. Lượng thức ăn phụ thuộc vào kích thước, tuổi tác và mức độ hoạt động của chó.',
    recommendations: [
      'Thịt nạc (gà, bò, cá)',
  ...
  },
  {
    ...
    description: 'Mèo là động vật ăn thịt bắt buộc, cần nhiều protein từ thịt. Chúng cũng cần taurine, một axit amin thiết yếu chỉ có trong mô động vật.',
    recommendations: [
  ...
  },
  {
    ...
    description: 'Chim cần một chế độ ăn đa dạng bao gồm hạt, trái cây, rau và protein. Nhu cầu dinh dưỡng có thể khác nhau tùy theo loài chim.',
    recommendations: [
  ...
  },
  {
    ...
    description: 'Cá cần thức ăn cân bằng phù hợp với loài cụ thể. Một số là động vật ăn thịt, một số ăn thực vật, và một số ăn tạp.',
    recommendations: [
