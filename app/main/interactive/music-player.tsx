...
export default function MusicPlayerScreen() {
    ...
    const [tracks, setTracks] = useState<Track[]>([
        ...
        },
        {
            ...
            duration: 240,
            imageUrl:
                'https://images.unsplash.com/photo-1500829243541-74b677fecc30?q=80&w=2076&auto=format&fit=crop',
        },
        {
            id: '3',
            title: 'Gentle Rain',
            ...
            duration: 300,
            imageUrl:
                'https://images.unsplash.com/photo-1428592953211-077101b2021b?q=80&w=2074&auto=format&fit=crop',
        },
    ]);
    ...
    const deleteTrack = (id: string) => {
        Alert.alert('Xác nhận', 'Bạn có chắc muốn xóa bản nhạc này?', [
            {
                text: 'Hủy',
                style: 'cancel',
            },
            ...
            <View style={styles.content}>
                ...
                <View style={styles.playlistContainer}>
                    <View style={styles.playlistHeader}>
                        ...
                        <TouchableOpacity style={styles.addButton} onPress={addNewTrack}>
