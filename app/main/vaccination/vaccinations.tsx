          ...
          <View style={styles.content}>
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.infoText}>
                Tiêm phòng là một phần quan trọng trong việc chăm sóc thú cưng. Nó giúp bảo vệ thú cưng của bạn khỏi nhiều bệnh nguy hiểm và đảm bảo sức khỏe lâu dài.
              </Text>
              <Text style={styles.infoSubtitle}>Các loại vắc-xin phổ biến cho chó:</Text>
              ...
              <Text style={styles.infoSubtitle}>Các loại vắc-xin phổ biến cho mèo:</Text>
              <Text style={styles.infoListItem}>• Vắc-xin phòng bệnh dại</Text>
              <Text style={styles.infoListItem}>• Vắc-xin 3 in 1 (FPV)</Text>
              <Text style={styles.infoListItem}>• Vắc-xin phòng bệnh giảm bạch cầu (FeLV)</Text>
            </View>
          </View>
        ) : (
