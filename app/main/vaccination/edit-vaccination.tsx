...
export default function EditVaccinationScreen() {
    ...
    const { vaccinations, pets, updateVaccination } = usePetStore();
    ...
    useEffect(() => {
        if (vaccination) {
            ...
            setNextDueDate(new Date(vaccination.nextDueDate));
            setVetName(vaccination.vetName);
    ...
    const handleSubmit = () => {
        if (!validateForm() || !vaccination) return;
