...
export default function AddMedicalDocumentScreen() {
    const router = useRouter();
    const { getActivePet, addMedicalDocument } = usePetStore();
    ...
    const [type, setType] = useState<
        'lab_result' | 'prescription' | 'xray' | 'certificate' | 'other'
    >('lab_result');
                    ...
                    <View style={styles.formGroup}>
                        ...
                        <View style={styles.typeButtonsContainer}>
                            <TouchableOpacity
                                style={[
                                    styles.typeButton,
                                    type === 'lab_result' && styles.activeTypeButton,
                                ]}
                            ...
                            >
                                <Text
                                    style={[
                                        ...
                                        type === 'lab_result' && styles.activeTypeButtonText,
                                    ]}
                                >
                                    Xét nghiệm
                                </Text>
                            ...
                            <TouchableOpacity
                                style={[
                                    styles.typeButton,
                                    type === 'prescription' && styles.activeTypeButton,
                                ]}
                            ...
                            >
                                <Text
                                    style={[
                                        styles.typeButtonText,
                                        type === 'prescription' && styles.activeTypeButtonText,
                                    ]}
                                >
                                    Đơn thuốc
                                </Text>
                            ...
                            <TouchableOpacity
                                style={[
                                    styles.typeButton,
                                    type === 'xray' && styles.activeTypeButton,
                                ]}
                            ...
                            >
                                <Text
                                    style={[
                                        styles.typeButtonText,
                                        type === 'xray' && styles.activeTypeButtonText,
                                    ]}
                                >
                                    X-quang
                                </Text>
                            ...
                            <TouchableOpacity
                                style={[
                                    styles.typeButton,
                                    type === 'certificate' && styles.activeTypeButton,
                                ]}
                            ...
                            >
                                <Text
                                    style={[
                                        styles.typeButtonText,
                                        type === 'certificate' && styles.activeTypeButtonText,
                                    ]}
                                >
                                    Chứng nhận
                                </Text>
