...
import { FileText, Plus, Search, Filter, FilePen, FileImage, FileCheck, FileClock, X } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container} edges={['right', 'left']}>
      ...
      <View style={styles.filterContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.filterScrollContent}>
          ...
          <TouchableOpacity 
            style={[styles.filterButton, activeFilter === 'lab_result' && styles.activeFilterButton]}
            onPress={() => setActiveFilter('lab_result')}
          >
            <Text style={[styles.filterButtonText, activeFilter === 'lab_result' && styles.activeFilterButtonText]}>
              Xét nghiệm
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterButton, activeFilter === 'prescription' && styles.activeFilterButton]}
            onPress={() => setActiveFilter('prescription')}
          >
            <Text style={[styles.filterButtonText, activeFilter === 'prescription' && styles.activeFilterButtonText]}>
              Đơn thuốc
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterButton, activeFilter === 'xray' && styles.activeFilterButton]}
            onPress={() => setActiveFilter('xray')}
          >
            <Text style={[styles.filterButtonText, activeFilter === 'xray' && styles.activeFilterButtonText]}>
              X-quang
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterButton, activeFilter === 'certificate' && styles.activeFilterButton]}
            onPress={() => setActiveFilter('certificate')}
          >
            <Text style={[styles.filterButtonText, activeFilter === 'certificate' && styles.activeFilterButtonText]}>
              Chứng nhận
            </Text>
          </TouchableOpacity>
          <TouchableOpacity 
          ...
          >
            <Text style={[styles.filterButtonText, activeFilter === 'other' && styles.activeFilterButtonText]}>
              Khác
            </Text>
          </TouchableOpacity>
        </ScrollView>
