...
export default function DiseasesScreen() {
    ...
    const categories = ['Tất cả', 'Tiêu hóa', 'Da liễu', 'Hô hấp', 'Ký sinh trùng'] as const;
    ...
    const fetchDiseases = useCallback(async () => {
        ...
        try {
            ...
            const baseConstraints: any[] = [where('petType', 'array-contains', activePet.species)];
            ...
            if (searchText.trim()) {
                ...
                filtered = all.filter((item) => item.disease_name_lower.includes(txt));
            }
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={styles.emergencyContainer}>
                            ...
                            <View style={styles.emergencyItems}>
                                {['Khó thở', 'Co giật', 'Chấn thương', 'Nôn mửa kéo dài'].map(
                                    (symptom, idx) => (
                        ...
                        <View style={styles.infoContainer}>
                            ...
                            <Text style={styles.infoText}>
                                Thông tin trong ứng dụng chỉ mang tính chất tham khảo và không thay
                                thế cho tư vấn của bác sĩ thú y. Nếu thú cưng của bạn có dấu hiệu
                                bệnh, hãy đưa đến phòng khám thú y ngay lập tức.
                            </Text>
                        </View>
                    </View>
                ) : (
