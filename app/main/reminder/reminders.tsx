            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {activePet ? (
                        ...
                        <View style={styles.tipsContainer}>
                            ...
                            <View style={styles.tipItem}>
                                ...
                                <Text style={styles.tipText}>
                                    Thiết lập lịch cho ăn cố định giúp thú cưng của bạn có thói quen
                                    tốt và hệ tiêu hóa khỏe mạnh.
                                </Text>
                            </View>
                            ...
                            <View style={styles.tipItem}>
                                ...
                                <Text style={styles.tipText}>
                                    Đảm bảo thú cưng của bạn được vận động đầy đủ mỗi ngày để duy
                                    trì sức khỏe và cân nặng lý tưởng.
                                </Text>
                            </View>
                            ...
                            <View style={styles.tipItem}>
                                ...
                                <Text style={styles.tipText}>
                                    Chải lông thường xuyên giúp giảm rụng lông và ngăn ngừa các vấn
                                    đề về da.
                                </Text>
                            </View>
                        </View>
                    ...
                    <View style={styles.emptyContainer}>
                        <Text style={styles.emptyText}>Vui lòng chọn thú cưng để xem nhắc nhở</Text>
                    </View>
                )}
            </ScrollView>
        </SafeAreaView>
