                        ...
                        <View style={styles.headerContainer}>
                            <View style={styles.headerContent}>
                                ...
                                <Text style={styles.subtitle}>
                                    Thông tin dinh dưỡng cho {activePet.name}
                                </Text>
                            </View>
                            <Image source={{ uri: activePet.imageUrl }} style={styles.petImage} />
                        </View>
                        ...
                        <View style={styles.tipsContainer}>
                            ...
                            <View style={styles.tipItem}>
                                ...
                                <View style={styles.tipContent}>
                                    ...
                                    <Text style={styles.tipText}>
                                        Kiểm soát khẩu phần ăn để tránh thừa cân hoặc suy dinh
                                        dưỡng.
                                    </Text>
                                </View>
                            </View>
                            ...
                            <View style={styles.tipItem}>
                                ...
                                <View style={styles.tipContent}>
                                    ...
                                    <Text style={styles.tipText}>
                                        Khi thay đổi thức ăn, hãy làm từ từ trong 7-10 ngày để tránh
                                        rối loạn tiêu hóa.
                                    </Text>
                                </View>
                            </View>
