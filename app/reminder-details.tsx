...
export default function ReminderDetailsScreen() {
  ...
  const getTypeText = (type: string) => {
    switch (type) {
      ...
      case 'grooming': return 'Vệ sinh';
      case 'exercise': return 'Tập thể dục';
      case 'vet': return 'Khám bác sĩ';
      default: return 'Khác';
    }
  };
    ...
    <SafeAreaView style={styles.container} edges={['right', 'left']}>
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            <View style={styles.infoItem}>
              ...
              <View>
                ...
                <Text style={styles.infoValue}>{getRepeatText(reminder.repeat)}</Text>
              </View>
            </View>
          ...
          <TouchableOpacity 
            style={[styles.completeButton, reminder.completed && styles.incompleteButton]} 
            onPress={handleToggleComplete}
          >
            <Check size={20} color={Colors.card} />
            <Text style={styles.completeButtonText}>
              {reminder.completed ? "Đánh dấu chưa hoàn thành" : "Đánh dấu hoàn thành"}
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
