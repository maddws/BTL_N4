...
import { View, Text, StyleSheet, Image, TouchableOpacity, TextInput, FlatList, KeyboardAvoidingView, Platform } from 'react-native';
  ...
  const handleComment = () => {
    ...
    const newComment: Comment = {
      ...
      author: {
        ...
        avatar: userProfile.avatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde',
      },
      content: comment,
            ...
            <View style={styles.postContainer}>
              ...
              <View style={styles.postActions}>
                ...
                <TouchableOpacity style={styles.actionButton} onPress={handleSave}>
                  ...
                  <Text style={[
                    styles.actionText,
                    post.isSaved && { color: Colors.primary }
                  ]}>Lưu</Text>
                </TouchableOpacity>
                    ...
                    {item.likes > 0 && (
                      <View style={styles.commentLikeCount}>
                        <Heart 
                          ...
                          fill={Colors.error} 
                        />
                        <Text style={styles.commentLikeCountText}>{item.likes}</Text>
                      </View>
                    )}
                  </TouchableOpacity>
