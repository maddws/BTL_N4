...
import { FileText, Plus, Stethoscope, Syringe, FileCheck, FileClock, FileImage, FilePen } from 'lucide-react-native';
...
export default function MedicalRecordsScreen() {
  ...
  const { getActivePet, getPetHealthRecords, getPetVaccinations, getPetMedicalDocuments } = usePetStore();
                ...
                vaccinations
                  ...
                  .map(vaccination => (
                    ...
                    >
                      ...
                      <View style={styles.recordContent}>
                        <Text style={styles.recordName}>{vaccination.name}</Text>
                        <Text style={styles.recordDate}>Ngày tiêm: {formatDate(vaccination.date)}</Text>
                        <Text style={styles.recordNextDate}>Tiêm tiếp theo: {formatDate(vaccination.nextDueDate)}</Text>
                      </View>
