...
export default function CheckoutScreen() {
  ...
  const { cart, getProductById, updateCartItemQuantity, removeFromCart, clearCart } = useShopStore();
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.paymentOptions}>
            ...
            >
              <Truck size={20} color={paymentMethod === 'cod' ? Colors.primary : Colors.textLight} />
              <Text style={[
            ...
            >
              <CreditCard size={20} color={paymentMethod === 'card' ? Colors.primary : Colors.textLight} />
              <Text style={[
                styles.paymentOptionText,
